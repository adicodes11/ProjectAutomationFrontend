...
export default function TeamMemberDashboard() {
  ...
  // Retrieve logged-in user's email from sessionStorage (projectId removed)
  ...
  // Update task status by matching on task.description, relying on email only
  const updateTaskStatus = async (taskDescription, newStatus) => {
    if (!teamAssignment) return; // Removed projectId check
